...
public enum SMUHCPlayerLevel {
    ...
    SMUHCPlayerLevel(int num, int min, int max) {
        levelNumber = num;
        minXP = min;
        maxXP = max;
    ...
    SMUHCPlayerLevel(int num, int min, int max, ChatColor color) {
        levelNumber = num;
        minXP = min;
        maxXP = max;
        chatColor = color;
     ...
     * @return
     */
    public boolean isGreaterThan(SMUHCPlayerLevel level) {
     ...
     * @return
     */
    public boolean isLessThan(SMUHCPlayerLevel level) {
        return (getLevelNumber() < level.getLevelNumber());
    }
}
